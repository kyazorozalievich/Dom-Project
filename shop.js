let products = document.querySelector(".shops");
...
localStorage.setItem("shop", JSON.stringify(productShop));
    ...
    products.innerHTML += `
         ...
         ${
           Math.round(el.price) > 100
             ? '<img src="./img/shop/productSale.png" alt="sale" class="sale" />'
             : ""
         }
              ...
              ${
                el.rating.rate > 4
                  ? '<img src="./img/shop/productVip.webp" alt="vip" class="vip"/>'
                  : ""
              }
              <div class="text">
              <h2>${
